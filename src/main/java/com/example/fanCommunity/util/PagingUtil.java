...
public class PagingUtil {
    ...
    private int currentPage = 1; //현재 페이지(디폴트는 첫번째 페이즈를 보여주므로 1
    ...
    public void resetPaging(int dataCount, int numPerPage) {
        ...
        //현재페이지가 totalPage보다 큰 경우는 있을 수 없으므로..
        if (currentPage > totalPage) currentPage = totalPage;

        // ◀ 이전 1 2 3 4 5 다음 ▶
        this.start = (currentPage - 1) * numPerPage + 1; // 1 6 11 16 ...
        this.end = currentPage * numPerPage; // 5 10 15 20 ...
    }
    ...
    public String pageIndexList(String listUrl) {
        ...
        //...
        //currentPage=6, currentPageSetup=0
        ...
        //totalPage > numPerBlock: numPerBlock보다 전체 페이지가 많을때 이전 버튼이 생겨야 함으로
